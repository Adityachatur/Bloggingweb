...
const Contact = () => {
  ...
  const handlesubmit = (e) => {
    e.preventDefault();
    // Call the submission function when the form is submitted
    Formsubmit();
  };
        ...
        <div className='flex max-w-7xl max-h-4xl md:mx-auto my-8 gap-12 justify-center'>
          <div className='grid lg:grid-cols-2 md:grid-cols-2 mx-5 grid-cols-1 gap-1 '>
            <div className='flex md:justify-end md:mr-10 justify-center mx-auto '>
              <img
                src='https://img.freepik.com/premium-vector/cyber-safety-cyber-security-privacy-concept-cyber-defender-works-laptop_714605-12.jpg'
                className='lg:w-full w-80 rounded-lg'
                alt=''
              />
            </div>
            <div className='ml-4'>
              <div className='flex flex-col my-4'>
                ...
                <input
                  className='w-80 border-2 h-8 rounded'
                  type='text'
                  name='name'
                  id='name'
                  required
              ...
              <button type='submit' className='w-80 h-8 mx-auto text-textcol font-bold my-4  bg-bgcol3'>
