        ...
        <div>
            <footer class="bg-bgcol1 body-font">
                <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                    <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10 sm:m-auto">
                    ...
                    <div class="flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first">
                        <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                            ...
                            <nav class="list-none mb-10">
                                ...
                                <li>
                                    <span class="text-textcol hover:text-bgcol4 cursor-pointer">https://github.com/Adityachatur</span>
                                </li>
                                <li>
                ...
                <div className='bg-red flex w-full bg-gray-400 justify-center py-2 md:space-x-8 space-x-2'>
                    <div>
